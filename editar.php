...
// Dados iniciais = produto do banco
$dados = [
    'nome'       => $produto['nome'],
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($erros)) {
        $sql  = "UPDATE produtos
                 SET nome = :nome, fabricante = :fabricante,
...
<!-- Informação do produto sendo editado -->
<div class="alerta alerta-aviso" style="margin-bottom:1.25rem">
    <span>📦 Editando: <strong><?= htmlspecialchars($produto['nome']) ?></strong> (ID #<?= $produto['id'] ?>)</span>
</div>
